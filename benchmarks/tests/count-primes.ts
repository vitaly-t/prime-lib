...
export function testCountPrimes(): ITestResult {
    const tests: ITestInput = {
        '1e6': {
            x: 1e6,
            desc: 'Count primes in 1 million'
        },
        '1e7': {
            x: 1e7,
            desc: 'Count primes in 10 millions'
        },
        '1e8': {
            x: 1e8,
            desc: 'Count primes in 100 millions'
        },
        '1e9': {
            x: 1e9,
            desc: 'Count primes in 1 billion'
        },
        '1e10': {
            x: 1e10,
            desc: 'Count primes in 10 billions'
        },
        '1e11': {
            x: 1e11,
            desc: 'Count primes in 100 billions'
        },
        '1e12': {
            x: 1e12,
